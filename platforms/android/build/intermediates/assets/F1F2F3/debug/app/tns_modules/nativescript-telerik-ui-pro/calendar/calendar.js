...
var CalendarMonthViewStyle = (function (_super) {
    ...
    CalendarMonthViewStyle.prototype.syncSelectionShape = function () {
        if (this._owner && this._owner.android) {
            switch (this.selectionShape.toLowerCase()) {
                case commonModule.SelectionShape.None.toLowerCase():
                    var defaultDecorator = new com.telerik.widget.calendar.CellDecorationsLayer(this._owner.android);
                    this._owner.android.setCellDecorator(defaultDecorator);
                    break;
                case commonModule.SelectionShape.Round.toLowerCase():
                    var roundDecorator = new com.telerik.widget.calendar.decorations.CircularCellDecorator(this._owner.android);
                    roundDecorator.setStroked(false);
                    this._owner.android.setCellDecorator(roundDecorator);
                    break;
                case commonModule.SelectionShape.Square.toLowerCase():
                    var squareDecorator = new com.telerik.widget.calendar.decorations.SquareCellDecorator(this._owner.android);
                    squareDecorator.setStroked(false);
                    this._owner.android.setCellDecorator(squareDecorator);
                    break;
            }
        }
    };
